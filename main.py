...
# ---- 重构 P1：平台层已拆分到 quickdeck.platform ----
from quickdeck.platform.dpi import enable_dpi_awareness
...
# ---- 重构 P5c：卡片/文件夹控件已拆分到 quickdeck.ui.widgets ----
from quickdeck.ui.widgets.card import ShortcutCard
from quickdeck.ui.widgets.folder_frame import FolderFrame
